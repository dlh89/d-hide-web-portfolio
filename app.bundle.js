...
"use strict";
eval("\n\nvar _svgxuse = __webpack_require__(/*! svgxuse */ \"./node_modules/svgxuse/svgxuse.js\");\n\nvar _svgxuse2 = _interopRequireDefault(_svgxuse);\n\nvar _Accordion = __webpack_require__(/*! ./modules/Accordion */ \"./src/scripts/modules/Accordion.js\");\n\nvar _Accordion2 = _interopRequireDefault(_Accordion);\n\nvar _Carousel = __webpack_require__(/*! ./modules/Carousel */ \"./src/scripts/modules/Carousel.js\");\n\nvar _Carousel2 = _interopRequireDefault(_Carousel);\n\nvar _Navigation = __webpack_require__(/*! ./modules/Navigation */ \"./src/scripts/modules/Navigation.js\");\n\nvar _Navigation2 = _interopRequireDefault(_Navigation);\n\nvar _ContactForm = __webpack_require__(/*! ./modules/ContactForm */ \"./src/scripts/modules/ContactForm.js\");\n\nvar _ContactForm2 = _interopRequireDefault(_ContactForm);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// polyfill to load svgs from external URI (unsupported by IE)\n\nvar accordion = new _Accordion2.default();\nvar navigation = new _Navigation2.default();\nvar carousel = new _Carousel2.default();\nvar contactForm = new _ContactForm2.default();\n\n//# sourceURL=webpack:///./src/scripts/app.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Carousel = function () {\n  function Carousel() {\n    _classCallCheck(this, Carousel);\n\n    var slides = Array.from(document.getElementsByClassName('carousel__slide'));\n    var navButtons = Array.from(document.getElementsByClassName('carousel__button'));\n    var sideButtons = Array.from(document.getElementsByClassName('carousel__side-buttons'));\n\n    navButtons.forEach(function (button) {\n      return button.addEventListener('click', function (e) {\n        return Carousel.change(e, slides, navButtons);\n      });\n    });\n    sideButtons.forEach(function (button) {\n      return button.addEventListener('click', function (e) {\n        return Carousel.nextOrPrev(e, slides, navButtons);\n      });\n    });\n  }\n\n  _createClass(Carousel, null, [{\n    key: 'change',\n    value: function change(e, slides, navButtons) {\n      var slideIndex = e.target.dataset.number - 1;\n      // classes for slides\n      Carousel.removeActiveClass(slides);\n      slides[slideIndex].classList.add('carousel__slide--active');\n\n      // classes for navButtons\n      Carousel.removeActiveClass(navButtons);\n      e.target.classList.add('carousel__button--active');\n    }\n  }, {\n    key: 'nextOrPrev',\n    value: function nextOrPrev(e, slides, navButtons) {\n      var slideCount = slides.length;\n      var slideIndex = 0;\n      // find the active slide\n      navButtons.forEach(function (button) {\n        if (button.className.includes('--active')) {\n          slideIndex = button.dataset.number - 1;\n        }\n      });\n      if (e.target.className.includes('right')) {\n        if (slideIndex === slideCount - 1) {\n          slideIndex = 0;\n        } else {\n          slideIndex += 1;\n        }\n      } else {\n        if (slideIndex === 0) {\n          slideIndex = slideCount - 1;\n        } else {\n          slideIndex -= 1;\n        }\n      }\n\n      // classes for slides\n      Carousel.removeActiveClass(slides);\n      slides[slideIndex].classList.add('carousel__slide--active');\n\n      // classes for navButtons\n      Carousel.removeActiveClass(navButtons);\n      navButtons[slideIndex].classList.add('carousel__button--active');\n    }\n  }, {\n    key: 'removeActiveClass',\n    value: function removeActiveClass(elements) {\n      elements.forEach(function (element) {\n        element.className = element.className.replace('--active', '');\n      });\n    }\n  }]);\n\n  return Carousel;\n}();\n\nexports.default = Carousel;\n\n//# sourceURL=webpack:///./src/scripts/modules/Carousel.js?");

/***/ }),

/***/ "./src/scripts/modules/ContactForm.js":
/*!********************************************!*\
  !*** ./src/scripts/modules/ContactForm.js ***!
  \********************************************/
/*! no static exports found */
