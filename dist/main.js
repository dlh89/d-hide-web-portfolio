...
var svgxuse = __webpack_require__(788);
...
class Carousel {
  constructor() {
    ...
    navButtons.forEach(button => button.addEventListener('click', e => Carousel.change(e, slides, navButtons)));
    sideButtons.forEach(button => button.addEventListener('click', e => Carousel.nextOrPrev(e, slides, navButtons)));
  }
...
const accordion = new modules_Accordion();
